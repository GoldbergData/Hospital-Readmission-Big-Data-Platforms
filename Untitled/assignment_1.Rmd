...
author: "Joshua Goldberg <br><span style='font-size: 50%;'> University of Chicago<br>Grahmn School, Data Science</span><br><br>"
date: "Winter 2019"
output:
  xaringan::moon_reader:
    css: [default, zh-CN.css, middlebury, robot-fonts]
    lib_dir: libs
    nature:
...
Data would be refreshed at numerous intervals, including during patient admission, treastment, and exit.
